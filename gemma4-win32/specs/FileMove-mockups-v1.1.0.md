...
- `About` is opened from the `New / Settings` right-click menu.
- The top image is centered and uses `FileGroupMover/Assets/Images/about-image.png`.
- The top section shows build information for Version `1.1.0`.
...
- `Status` is opened from the `New / Settings` right-click menu.
...
- Right click on the fixed `New / Settings` row opens this menu.
- `Settings` opens the Settings window.
- `Status` opens the Status window.
- `Search` opens the search dialog or search window.
- `New` opens the New Group window.
...
- `Queue Window` is opened from the `New / Settings` right-click menu.
